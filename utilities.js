...
var Utilities = {
	 ...
	 *
	 * @param {String} baseURL Web page URL
	 * @param {Object} jsonld JSON-LD block
	 ...
	 */
	approximateMatch: function (text, pattern, maxErrors) {
		/**
	...
	/**
	 * Normalize text by transforming diacritics, ligatures, etc. to ASCII letters and numbers
	 *
	 * While still keep the essence of the text
	 * To preprocess text before matching
	 *
	 * @param {String} text
	 * @return {String}
	 */
